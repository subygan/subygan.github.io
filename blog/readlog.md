...
- [How to dropout](https://ranprieur.com/essays/dropout.html#HTDO){:target="_blank"}
  ...
  - [this quote from the article](https://ranprieur.com/essays/dropout.html#:~:text=So%20even%20play,almost%20to%20death){:target="_blank"} sadly rings too true in my life. But, is that such a bad thing though?? 
...
- [China's top education firm's cut 60,000 jobs](https://www.bloomberg.com/news/articles/2022-01-10/china-s-top-education-firm-cut-60-000-jobs-after-tutoring-curbs){:target="_blank"}
  - A pretty good reminder that, most "tech" companies seem to be working (?){:target="_blank"} under only the premise that there will be little to no regulation from the government. This makes sense...
...
- [Swapnil's computer systems readup](https://one.nilinswap.com/blog/readlog/books/computer_systems){:target="_blank"} Even though a summary, learnt some insightful stuff.
...
- [“Play-to-earn” and Bullshit Jobs](https://paulbutler.org/2021/play-to-earn-and-bullshit-jobs/){:target="_blank"}
  - Corollary to that, [Bullshit Jobs](https://www.strike.coop/bullshit-jobs/){:target="_blank"}. David Graeber's bullshit jobs theory.
...
- for no Absolute reason Got curious of the growth of AdGrok Because, usually success stories are written with hindsight bias. [Here's the whole list](https://hn.algolia.com/?dateRange=all&page=0&prefix=true&query=adgrok&sort=byDate&type=story){:target="_blank"}
...
- [RSS vs Atom](http://www.intertwingly.net/wiki/pie/Rss20AndAtom10Compared){:target="_blank"}
  ...
  - Analogous thread in jekyll [https://github.com/jekyll/jekyll-feed/issues/2](https://github.com/jekyll/jekyll-feed/issues/2){:target="_blank"}
...
- [Avoiding internet centralisation](https://mnot.github.io/avoiding-internet-centralization/draft-nottingham-avoiding-internet-centralization.html){:target="_blank"}
  - Types of cenralization
    ...
    - __Neessary centralisation__ - eg. DNS, Certificate Authority (CA){:target="_blank"} due to technical limitations. 
  ...
  - __Limits of Decentralisation__ - there is no completely decentralised system. Although there has been some attempt at it. Centralisation starts evolving
    - __Federation is not enough__ - SMTP was evolved as a method to have a decentralised way to receive message even when the underlying Network, IP or the server changes. One way it is done is, The DNS handles the finding the user part and the Mail Transfer Agent (MTA){:target="_blank"} can be used to route message to anyone. But this has created a situation where there are Indirectly centralised systems like Gmail. Who have much better network effects and are able to elbow other small players away.
    ...
    - __Blockchains are not magical__ - Blockchains try to reduce centralization risk by distributing intermediary or otherwise potentially centralized functions to members of a large pool of protocol participants. The assignment of a task usually cannot be controlled (to avoid sybill attacks){:target="_blank"}. These prevent _direct centralization, inherited centralisation_. There are a few issues with this though
      - __Distributed consensus protocols can have significant implications for privacy.__ Because all activities are shared with many unknown parties. Private Information Retrieval is incredibly (PIR){:target="_blank"} is incredibly easy
...
- glupteba botnetwork litigation by google
  - Here's the technical write up [https://blog.google/threat-analysis-group/disrupting-glupteba-operation/](https://blog.google/threat-analysis-group/disrupting-glupteba-operation/){:target="_blank"}
  - Here's their legal write up [https://blog.google/technology/safety-security/new-action-combat-cyber-crime/](https://blog.google/technology/safety-security/new-action-combat-cyber-crime/){:target="_blank"}
  - Here's their litigation doc [https://storage.googleapis.com/gweb-uniblog-publish-prod/documents/1_Complaint.pdf](https://storage.googleapis.com/gweb-uniblog-publish-prod/documents/1_Complaint.pdf){:target="_blank"}
...
- Was reading (and writing!!!){:target="_blank"} about Docker and its internals which can be found [here](https://github.com/suriya-ganesh/docker_learn){:target="_blank"}
